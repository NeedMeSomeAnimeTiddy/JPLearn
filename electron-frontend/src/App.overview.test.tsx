...
/**
 * Search and mastery filters over the kanji chips.
 *
 * The view pages at 45 chips, so N1's 1,192 kanji were 27 pages of prev/next with
 * no way to jump to one character. Narrowing the set is what makes it reachable.
 */

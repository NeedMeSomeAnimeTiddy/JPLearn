...
import { Activity, ArrowLeft, ArrowRight, BookText, BrainCircuit, CheckCircle2, Circle, Download, Flame, Keyboard, Languages, MessageCircle, Minimize2, Minus, PlayCircle, Power, RefreshCw, RotateCcw, Trash2, Trophy, Upload, X } from 'lucide-react'
import {
  PERFORMANCE_GOOD_MS,
...
import { useTutor, TutorPanel, TutorToast, TutorSettingsTab, clampAssistantChatOcrMinConfidence, type TutorSettingsFields } from './features/tutor'

...
contextBridge.exposeInMainWorld('jplearnDesktop', {
  ...
  downloadPipelineModel: (tier, options) => ipcRenderer.invoke('setup:download-pipeline-model', tier, options),
  applyTranslationProfile: (tier, options) => ipcRenderer.invoke('setup:apply-translation-profile', tier, options),
  uninstallPipelineModel: (tier) => ipcRenderer.invoke('setup:uninstall-pipeline-model', tier),

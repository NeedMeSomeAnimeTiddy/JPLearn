...
function getSplashPalette(theme) {
  const palettes = {
    ...
    lofi_dusk: {
      bgA: '#f3e6d3',
      bgB: '#e6d4be',
      glowA: 'rgba(176, 122, 92, 0.22)',
      glowB: 'rgba(143, 175, 166, 0.18)',
      glowC: 'rgba(217, 179, 140, 0.18)',
      panelA: 'rgba(230, 212, 190, 0.92)',
      panelB: 'rgba(223, 204, 178, 0.9)',
      border: 'rgba(143, 122, 110, 0.32)',
      spinnerTrack: 'rgba(176, 122, 92, 0.2)',
      spinnerHead: '#b07a5c',
      title: '#5b4a53',
      subtitle: 'rgba(91, 74, 83, 0.82)',
      accent: '#b07a5c',
    },
    lofi_dusk_light: {
      bgA: '#f3e6d3',
      bgB: '#e9d8c1',
      glowA: 'rgba(176, 122, 92, 0.24)',
      glowB: 'rgba(110, 145, 135, 0.18)',
      glowC: 'rgba(176, 122, 92, 0.22)',
      panelA: 'rgba(250, 242, 231, 0.96)',
      panelB: 'rgba(244, 233, 218, 0.94)',
      border: 'rgba(91, 74, 83, 0.34)',
      spinnerTrack: 'rgba(176, 122, 92, 0.24)',
      spinnerHead: '#b07a5c',
      title: '#1f2433',
      subtitle: 'rgba(91, 74, 83, 0.8)',
      accent: '#b07a5c',
    },
    harbor_mist: {
      bgA: '#0a161f',
